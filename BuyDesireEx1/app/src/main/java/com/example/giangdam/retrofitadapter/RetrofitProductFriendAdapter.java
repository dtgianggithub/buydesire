 ...
 */
public class RetrofitProductFriendAdapter extends BaseAdapter {
    ...
    public RetrofitProductFriendAdapter(Context context, int layoutId, ArrayList<Desire> arrayList){
        super();
