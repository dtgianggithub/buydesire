 ...
 */
public class MyStoreDetailShowroomAdapter extends BaseAdapter {
    ...
    public MyStoreDetailShowroomAdapter(Context context, int layoutId, ArrayList<Desire> arrayList){
        super();
